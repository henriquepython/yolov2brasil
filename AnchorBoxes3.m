...
% COMBINA TODOS OS DADOS DAS CAIXAS DO GTRUTH DENTRO DE UM VETOR.
allBoxes = vertcat(trainingData.COM_MASCARA{:},trainingData.SEM_M{:});

% PLOTA GRAFICO DAS CAIXAS.
